...
class Proposed extends RowAction
{
    ...
    public function handle($id, Request $request)
    {
        ...
        $config = [
            ...
            'subject' => 'Customer Proposed',
        ];

        Helper::sendMail('mail.email_proposed', $data_mail_customer, $config, []);

        return $this->response()->success('Proposed submitted')->refresh();
    }
