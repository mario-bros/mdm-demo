...
class PostCustomerRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rules = [
            ...
            'spouse_full_name' => 'max:100',
            'spouse_middle_name' => 'max:100',
            'spouse_last_name' => 'max:100',
            'spouse_relationship' => 'max:50',
            'spouse_date_of_birth' => 'date_format:Y-m-d|nullable',
            'spouse_place_of_birth' => 'max:50',
            'spouse_gender' => 'max:50',
            'spouse_marital_status' => 'max:50',
            'spouse_religion' => 'max:50',
            'spouse_nationality' => 'max:50',
            'spouse_id_type' => 'max:50',
            'spouse_id_no' => 'max:50',
            'spouse_home_address_1' => 'max:250',
            'spouse_home_address_2' => 'max:250',
            'spouse_home_district' => 'max:250',
            'spouse_home_district' => 'max:50',
            'spouse_home_subdistrict' => 'max:50',
            'spouse_home_city' => 'max:50',
            'spouse_home_province' => 'max:50',
            'spouse_home_postal_code' => 'max:10',
            'spouse_home_country' => 'max:50',
            'spouse_home_status' => 'max:50',
            'spouse_home_phone_no' => 'max:50',
            'spouse_mobile_phone_no' => 'max:50',
            'spouse_email_address' => 'max:100',
            'spouse_occupation' => 'max:50',
            'spouse_current_position' => 'max:100',
        ];
