...
--
-- Name: mdm_staging_finance; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA mdm_staging_finance;
...
--
-- Name: mdm_staging_customer_profile; Type: TABLE; Schema: mdm_staging_finance; Owner: -
--

CREATE TABLE mdm_staging_finance.mdm_staging_customer_profile (
    u_id character varying(250) NOT NULL,
    unit character varying(50) DEFAULT 'FINA'::character varying,
    ...
    spouse_date_of_birth timestamp without time zone,
...
ALTER TABLE ONLY mdm_staging_finance.mdm_staging_customer_profile
