...
class CreateMdmCustomerProfileTable extends Migration {
	...
	public function up()
	{
		Schema::create('mdm_customer_profile', function(Blueprint $table)
		{
			$table->string('u_id', 250)->nullable()->index();
			$table->string('uid_golden', 250)->nullable()->index();
	...
	{
		Schema::drop('mdm_customer_profile');
	}
