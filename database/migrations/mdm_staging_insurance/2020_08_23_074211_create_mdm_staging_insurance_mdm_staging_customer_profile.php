...
class CreateMdmStagingInsuranceMdmStagingCustomerProfile extends Migration {
	...
	public function up()
	{
		Schema::connection('INSU')->create('mdm_staging_customer_profile', function(Blueprint $table)
		{
			$table->string('u_id', 250)->primary('mdm_staging_customer_profile_pkey');
			$table->string('unit', 50)->nullable()->default('INSU');
	...
	{
		Schema::connection('INSU')->drop('mdm_staging_customer_profile');
	}
}
